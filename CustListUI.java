...
Connection con;
    ...
    private void initComponents() {
        ...
        TABLE.setModel(new javax.swing.table.DefaultTableModel(new Object [][] {},new String [] { "Customer ID", "Name", "Address", "City", "Phone"}) 
        {
            /**
			 * 
			 */
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Big_bazaar_label.jpg"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(771, 401));
 ...
 int rows = model.getRowCount();
        ...
        try {
            ...
            Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/Shopping_Mall","root","");
    ...
    private void UPDATEbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UPDATEbtnActionPerformed
        ...
        String query2; 
              try
               {
                   con = DriverManager.getConnection("jdbc:mysql://localhost:3306/Shopping_Mall","root","");
...
query2="UPDATE EMPLOYEE SET SHOPPER_ID=" + N + ", NAME = '" + H + "',PHONE=" + P + ",CITY='"+ L + "',ADDRESS='"+ M + "' WHERE SHOPPER_ID=" + N +";";
        ...
        try
        {
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/big_bazaar","root","");
